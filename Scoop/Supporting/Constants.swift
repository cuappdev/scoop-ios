...
struct Constants {
    ...
    static let defaultUser = BaseUser(id: 0, netid: "netid", firstName: "firstName", lastName: "lastName", phoneNumber: "phone", profilePicUrl: "", grade: "grade", pronouns: "pronouns", prompts: [])
