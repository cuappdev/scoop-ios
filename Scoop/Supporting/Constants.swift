...
struct Constants {
    ...
    static let defaultTRequest = Request(id: 0, approvee: defaultUser, approver: defaultUser, ride: defaultTruncRide, approved: true, timestamp: "2020-03-27T00:00:00Z")
    static let defaultFRequest = Request(id: 0, approvee: defaultUser, approver: defaultUser, ride: defaultTruncRide, approved: false, timestamp: "2020-03-27T00:00:00Z")
